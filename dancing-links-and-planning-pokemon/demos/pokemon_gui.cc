...
int main() {
  ...
  Dx::Type_encoding tester ( "Fire" );
  Pokemon_test interactions = load_pokemon_generation( gen );
  ...
  Gui::Window window( {.width = 1280, .height = 720, .title = std::string{ "Pokemon Type Coverage" }, .monitor = nullptr, .share = nullptr } );
